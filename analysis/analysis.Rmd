...
# bootstrapping has a long execution time, so load saved values if they've already been calculated
if(file.exists("models/probability_estimates.rds")) {
  
  probability_estimates <- read_rds("models/probability_estimates.rds")
  ...
  # save to disk
  write_rds(probability_estimates, "models/probability_estimates.rds")
